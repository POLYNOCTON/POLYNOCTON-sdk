...
All notable changes to the POLYCAVORA SDK will be documented in this file.
...
### Added
- Initial release of POLYCAVORA SDK
- `POLYCAVORASDK` class for interacting with Polymarket data
...
- Custom error classes (`POLYCAVORAError`, `HttpError`)
